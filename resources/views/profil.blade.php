...
<head>
    ...
    <nav class="navbar navbar-expand bg-white sticky-top text-right">
        <ul class="navbar-nav">
            <li class="nav-item"><a href="/" class="nav-link text-dark"><strong>Beranda</strong></a></li>
        </ul>
...
<body class="bg-dark">
    <div class="container-fluid">
        ...
        <br>
        <img src="koder.PNG" class="rounded-circle mx-auto d-block" alt="">
    </div>
    <br>
    <div class="text-center text-white">
        <h1>ALFAN HAFIIDH NUGRAHA</h1>
        <h1>XII RPL 2</h1>
        <h1>02</h1>
        <h1>0821 4041 6405</h1>
    </div>
</body>
</html>